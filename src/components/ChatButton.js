...
function ChatButton({ mode, selectedChat, changeMode, picture = 'blankprofile.png' }) {
  const isSelected = mode === selectedChat;
  return (
    <div
      className={`flex flex-row items-center p-3 cursor-pointer ${isSelected ? 'bg-blue-500 text-white'
              : 'bg-white text-gray-900 hover:bg-gray-200'} rounded-lg`}
